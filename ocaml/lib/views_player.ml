            ...
            <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 overflow-x-auto shadow-lg">
              <table class="min-w-[680px] sm:min-w-[920px] w-full text-xs sm:text-sm font-mono table-auto tabular-nums">
                <thead class="bg-slate-100/80 dark:bg-slate-800/80 sticky top-0 z-10 text-slate-600 dark:text-slate-400 uppercase tracking-wider text-[10px] sm:text-xs whitespace-nowrap">
                  <tr>
                    <th class="px-3 py-2 text-left font-sans w-[90px] sm:w-[110px]">Date</th>
                    <th class="px-3 py-2 text-left font-sans">Opponent</th>
                    <th class="px-3 py-2 text-right w-[60px] sm:w-[72px]">MIN</th>
                    <th class="px-3 py-2 text-right text-orange-600 dark:text-orange-400 w-[60px] sm:w-[72px]">PTS</th>
                    <th class="px-3 py-2 text-right w-[60px] sm:w-[72px]">+/-</th>
                    <th class="px-3 py-2 text-right w-[60px] sm:w-[72px]">REB</th>
                    <th class="px-3 py-2 text-right w-[60px] sm:w-[72px] hidden sm:table-cell">AST</th>
                    <th class="px-3 py-2 text-right w-[60px] sm:w-[72px] hidden sm:table-cell">STL</th>
                    <th class="px-3 py-2 text-right w-[60px] sm:w-[72px] hidden sm:table-cell">BLK</th>
                  </tr>
                </thead>
                <tbody>%s</tbody>
              </table>
