...
let teams_table ~season ~scope (stats: team_stats list) =
  ...
  Printf.sprintf
    {html|<div class="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 overflow-x-auto overflow-y-hidden"><table class="w-full min-w-[980px] text-xs sm:text-sm font-mono tabular-nums table-fixed" data-sortable id="teams-table-inner" aria-label="팀 통계 테이블">
      <thead class="bg-slate-100 dark:bg-slate-800/80 sticky top-0 z-10 text-slate-600 dark:text-slate-400 text-xs uppercase tracking-wider whitespace-nowrap"><tr><th class="px-3 py-2 text-left" style="min-width: 140px">Team</th><th class="px-3 py-2 text-right" data-sortable data-sort-key="gp" style="width: 60px; min-width: 60px; max-width: 60px;">GP</th><th class="px-3 py-2 text-right hidden md:table-cell" data-sortable data-sort-key="min" style="width: 72px; min-width: 72px; max-width: 72px;">%s</th><th class="px-3 py-2 text-right" data-sortable data-sort-key="pts" style="width: 72px; min-width: 72px; max-width: 72px;">PTS</th><th class="px-3 py-2 text-right" data-sortable data-sort-key="mg" title="MG: 팀 득실마진(PTS - PA)" style="width: 72px; min-width: 72px; max-width: 72px;">MG</th><th class="px-3 py-2 text-right hidden md:table-cell" data-sortable data-sort-key="pa" style="width: 72px; min-width: 72px; max-width: 72px;">PA</th><th class="px-3 py-2 text-right hidden sm:table-cell" data-sortable data-sort-key="reb" style="width: 72px; min-width: 72px; max-width: 72px;">REB</th><th class="px-3 py-2 text-right hidden sm:table-cell" data-sortable data-sort-key="ast" style="width: 72px; min-width: 72px; max-width: 72px;">AST</th><th class="px-3 py-2 text-right hidden md:table-cell" data-sortable data-sort-key="stl" style="width: 72px; min-width: 72px; max-width: 72px;">STL</th><th class="px-3 py-2 text-right hidden md:table-cell" data-sortable data-sort-key="blk" style="width: 72px; min-width: 72px; max-width: 72px;">BLK</th><th class="px-3 py-2 text-right hidden md:table-cell" data-sortable data-sort-key="to" style="width: 72px; min-width: 72px; max-width: 72px;">TO</th><th class="px-3 py-2 text-right hidden lg:table-cell" data-sortable data-sort-key="fg" style="width: 72px; min-width: 72px; max-width: 72px;">FG%%</th><th class="px-3 py-2 text-right hidden lg:table-cell" data-sortable data-sort-key="3p" style="width: 72px; min-width: 72px; max-width: 72px;">3P%%</th><th class="px-3 py-2 text-right hidden lg:table-cell" data-sortable data-sort-key="ft" style="width: 72px; min-width: 72px; max-width: 72px;">FT%%</th><th class="px-3 py-2 text-right hidden lg:table-cell" data-sortable data-sort-key="efg" style="width: 72px; min-width: 72px; max-width: 72px;">eFG%%</th><th class="px-3 py-2 text-right hidden lg:table-cell text-emerald-600 dark:text-emerald-400" data-sortable data-sort-key="ts" title="True Shooting %%" style="width: 72px; min-width: 72px; max-width: 72px;">TS%%</th><th class="px-3 py-2 text-right text-orange-600 dark:text-orange-400" data-sortable data-sort-key="eff" style="width: 72px; min-width: 72px; max-width: 72px;">EFF</th></tr></thead><tbody>%s</tbody></table></div>|html}
    min_label rows
