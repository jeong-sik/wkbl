...
let team_stat_row ~season (row: team_stats) =
 ...
 let margin_str = if row.margin > 0.0 then Printf.sprintf "+%.1f" row.margin else format_float row.margin in
   ...
   let gp_cell = Printf.sprintf {html|<td class="px-3 py-2 text-right whitespace-nowrap" style="width: 64px; min-width: 64px;"><span class="text-slate-600 dark:text-slate-400 font-mono">%d</span></td>|html} row.gp in
 ...
 let min_label = if scope = PerGame then "MIN/G" else "MIN" in
    Printf.sprintf
      {html|<div class="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 overflow-x-auto overflow-y-hidden"><table class="w-full min-w-[980px] text-xs sm:text-sm font-mono tabular-nums table-auto" data-sortable id="teams-table-inner" aria-label="팀 통계 테이블">
        <thead class="bg-slate-100 dark:bg-slate-800/80 sticky top-0 z-10 text-slate-600 dark:text-slate-400 text-xs uppercase tracking-wider whitespace-nowrap"><tr><th class="px-3 py-2 text-left whitespace-nowrap">Team</th><th class="px-3 py-2 text-right whitespace-nowrap" data-sortable data-sort-key="gp" style="width: 64px; min-width: 64px;">GP</th><th class="px-3 py-2 text-right hidden md:table-cell whitespace-nowrap" data-sortable data-sort-key="min" style="width: 80px; min-width: 80px;">%s</th><th class="px-3 py-2 text-right whitespace-nowrap" data-sortable data-sort-key="pts" style="width: 80px; min-width: 80px;">PTS</th><th class="px-3 py-2 text-right whitespace-nowrap" data-sortable data-sort-key="mg" title="MG: 팀 득실마진(PTS - PA)" style="width: 80px; min-width: 80px;">MG</th><th class="px-3 py-2 text-right hidden md:table-cell whitespace-nowrap" data-sortable data-sort-key="pa" style="width: 80px; min-width: 80px;">PA</th><th class="px-3 py-2 text-right hidden sm:table-cell whitespace-nowrap" data-sortable data-sort-key="reb" style="width: 80px; min-width: 80px;">REB</th><th class="px-3 py-2 text-right hidden sm:table-cell whitespace-nowrap" data-sortable data-sort-key="ast" style="width: 80px; min-width: 80px;">AST</th><th class="px-3 py-2 text-right hidden md:table-cell whitespace-nowrap" data-sortable data-sort-key="stl" style="width: 80px; min-width: 80px;">STL</th><th class="px-3 py-2 text-right hidden md:table-cell whitespace-nowrap" data-sortable data-sort-key="blk" style="width: 80px; min-width: 80px;">BLK</th><th class="px-3 py-2 text-right hidden md:table-cell whitespace-nowrap" data-sortable data-sort-key="to" style="width: 80px; min-width: 80px;">TO</th><th class="px-3 py-2 text-right hidden lg:table-cell whitespace-nowrap" data-sortable data-sort-key="fg" style="width: 80px; min-width: 80px;">FG%%</th><th class="px-3 py-2 text-right hidden lg:table-cell whitespace-nowrap" data-sortable data-sort-key="3p" style="width: 80px; min-width: 80px;">3P%%</th><th class="px-3 py-2 text-right hidden lg:table-cell whitespace-nowrap" data-sortable data-sort-key="ft" style="width: 80px; min-width: 80px;">FT%%</th><th class="px-3 py-2 text-right hidden lg:table-cell whitespace-nowrap" data-sortable data-sort-key="efg" style="width: 80px; min-width: 80px;">eFG%%</th><th class="px-3 py-2 text-right hidden lg:table-cell text-emerald-600 dark:text-emerald-400 whitespace-nowrap" data-sortable data-sort-key="ts" title="True Shooting %%" style="width: 80px; min-width: 80px;">TS%%</th><th class="px-3 py-2 text-right text-orange-600 dark:text-orange-400 whitespace-nowrap" data-sortable data-sort-key="eff" style="width: 80px; min-width: 80px;">EFF</th></tr></thead><tbody>%s</tbody></table></div>|html}
      min_label rows
 ...
 let rows =
  ...
  |> List.mapi (fun i (g : game_summary) ->
    ...
    if g.home_score = None then ""
     ...
     Printf.sprintf
      {html|<tr class="border-b border-slate-200 dark:border-slate-800/60 hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-colors"><td class="px-4 py-3 text-slate-600 dark:text-slate-400 font-mono text-sm hidden sm:table-cell text-center w-14">%d</td><td class="px-4 py-3 text-slate-600 dark:text-slate-400 font-mono text-sm whitespace-nowrap w-32">%s</td><td class="px-4 py-3 font-medium text-right w-auto"><span class="inline-flex items-center justify-end gap-2 whitespace-nowrap">%s<a href="/team/%s" class="team-name hover:text-orange-600 dark:text-orange-400 dark:hover:text-orange-300 transition-colors whitespace-nowrap">%s</a></span></td><td class="px-4 py-3 text-center font-bold text-slate-900 dark:text-slate-200 font-mono w-20">%d</td><td class="px-4 py-3 text-center font-bold text-slate-900 dark:text-slate-200 font-mono w-20">%d</td><td class="px-4 py-3 font-medium text-left w-auto"><span class="inline-flex items-center gap-2 whitespace-nowrap"><a href="/team/%s" class="team-name hover:text-orange-600 dark:text-orange-400 dark:group-hover:text-orange-300 transition-colors whitespace-nowrap">%s</a>%s</span></td><td class="px-4 py-3 text-right font-mono %s hidden sm:table-cell w-20">%s</td><td class="px-4 py-3 text-right w-20">
