...
let games_table (games : game_summary list) =
  ...
  let rows =
    ...
    |> List.mapi (fun i (g : game_summary) ->
        ...
        let status_class = if g.home_score = None then "text-slate-600 dark:text-slate-400" else "text-slate-900 dark:text-slate-200" in
        Printf.sprintf
          {html|<tr class="border-b border-slate-200 dark:border-slate-800/60 hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-colors group %s"><td class="px-4 py-3 text-slate-600 dark:text-slate-400 font-mono text-sm hidden sm:table-cell group-hover:text-slate-900 dark:group-hover:text-slate-200 transition-colors text-center">%d</td><td class="px-4 py-3 text-slate-600 dark:text-slate-400 font-mono text-sm whitespace-nowrap group-hover:text-slate-900 dark:group-hover:text-slate-200 transition-colors">%s</td><td class="px-4 py-3 font-medium" style="width: max-content; white-space: nowrap;"><span class="inline-flex items-center gap-2" style="white-space: nowrap;">%s<a href="/team/%s" class="team-name group-hover:text-orange-600 dark:text-orange-400 dark:group-hover:text-orange-300 transition-colors" style="white-space: nowrap;">%s</a></span></td><td class="px-4 py-3 text-center font-bold text-orange-600 dark:text-orange-400 font-mono group-hover:scale-110 transition-transform whitespace-nowrap">%s - %s</td><td class="px-4 py-3 text-right font-medium" style="width: max-content; white-space: nowrap;"><span class="inline-flex items-center justify-end gap-2" style="white-space: nowrap;"><a href="/team/%s" class="team-name group-hover:text-orange-600 dark:text-orange-400 dark:group-hover:text-orange-300 transition-colors" style="white-space: nowrap;">%s</a>%s</span></td><td class="px-4 py-3 text-right"><a href="/boxscore/%s" class="text-[10px] sm:text-xs bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 px-2 py-1 rounded text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition group-hover:ring-2 group-hover:ring-orange-500/50 whitespace-nowrap">Boxscore</a></td></tr>|html}
  ...
  in
  Printf.sprintf
    {html|<div class="space-y-3 sm:hidden">%s</div><div class="hidden sm:block bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 overflow-x-auto overflow-y-hidden shadow-2xl"><table class="min-w-[720px] sm:min-w-[860px] w-full text-xs sm:text-sm font-mono tabular-nums table-fixed" aria-label="경기 일정"><thead class="bg-slate-100 dark:bg-slate-800/80 sticky top-0 z-10 text-slate-600 dark:text-slate-400 text-xs uppercase tracking-wider whitespace-nowrap"><tr><th class="px-4 py-3 text-center hidden sm:table-cell w-14">#</th><th class="px-4 py-3 text-left font-sans w-32">Date</th><th class="px-4 py-3 text-left font-sans">Home</th><th class="px-4 py-3 text-center w-24">Score</th><th class="px-4 py-3 text-right font-sans">Away</th><th class="px-4 py-3 text-right font-sans w-24">Action</th></tr></thead><tbody id="games-body">%s</tbody></table></div>|html}
    mobile_cards rows
...
let boxscores_table (games : game_summary list) =
  ...
  let rows =
    ...
    |> List.mapi (fun i (g : game_summary) ->
        ...
        if g.home_score = None then ""
          ...
          Printf.sprintf
            {html|<tr class="border-b border-slate-200 dark:border-slate-800/60 hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-colors"><td class="px-4 py-3 text-slate-600 dark:text-slate-400 font-mono text-sm hidden sm:table-cell text-center">%d</td><td class="px-4 py-3 text-slate-600 dark:text-slate-400 font-mono text-sm whitespace-nowrap">%s</td><td class="px-4 py-3 font-medium text-right"><span class="inline-flex items-center justify-end gap-2 whitespace-nowrap">%s<a href="/team/%s" class="team-name hover:text-orange-600 dark:text-orange-400 dark:hover:text-orange-300 transition-colors whitespace-nowrap">%s</a></span></td><td class="px-4 py-3 text-center font-bold text-slate-900 dark:text-slate-200 font-mono">%d</td><td class="px-4 py-3 text-center font-bold text-slate-900 dark:text-slate-200 font-mono">%d</td><td class="px-4 py-3 font-medium text-left"><span class="inline-flex items-center gap-2 whitespace-nowrap"><a href="/team/%s" class="team-name hover:text-orange-600 dark:text-orange-400 dark:group-hover:text-orange-300 transition-colors whitespace-nowrap">%s</a>%s</span></td><td class="px-4 py-3 text-right font-mono %s hidden sm:table-cell">%s</td><td class="px-4 py-3 text-right">
  ...
  in
  Printf.sprintf
    {html|<div class="space-y-3 sm:hidden">%s</div><div class="hidden sm:block bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 overflow-x-auto overflow-y-hidden shadow-2xl"><table class="min-w-[720px] sm:min-w-[900px] w-full text-xs sm:text-sm font-mono tabular-nums table-fixed" aria-label="박스스코어 목록"><thead class="bg-slate-100 dark:bg-slate-800/80 sticky top-0 z-10 text-slate-600 dark:text-slate-400 text-xs uppercase tracking-wider whitespace-nowrap"><tr><th class="px-4 py-3 text-center hidden sm:table-cell w-14">#</th><th class="px-4 py-3 text-left font-sans w-32">Date</th><th class="px-4 py-3 text-right font-sans">Home</th><th class="px-4 py-3 text-center w-16 font-sans">PTS</th><th class="px-4 py-3 text-center w-16 font-sans">PTS</th><th class="px-4 py-3 text-left font-sans">Away</th><th class="px-4 py-3 text-right font-sans hidden sm:table-cell w-20">Margin</th><th class="px-4 py-3 text-right font-sans w-20">Link</th></tr></thead><tbody id="boxscores-body">%s</tbody></table></div>|html}
    mobile_cards rows
