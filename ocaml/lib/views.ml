...
let team_stat_row ~season (row: team_stats) =
 ...
 let cell ?(hide="") ?(color="text-slate-700 dark:text-slate-300") ?(width="") value =
  Printf.sprintf {html|<td class="px-3 py-2 text-right whitespace-nowrap %s %s"><span class="%s font-mono">%s</span></td>|html} hide width color value
 in
 ...
 let min_label = if scope = PerGame then "MIN/G" else "MIN" in
  Printf.sprintf
    {html|<div class="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 overflow-x-auto overflow-y-hidden"><table class="w-full min-w-[980px] text-xs sm:text-sm font-mono tabular-nums table-auto" data-sortable id="teams-table-inner" aria-label="팀 통계 테이블">
      <thead class="bg-slate-100 dark:bg-slate-800/80 sticky top-0 z-10 text-slate-600 dark:text-slate-400 text-xs uppercase tracking-wider whitespace-nowrap"><tr><th class="px-3 py-2 text-left whitespace-nowrap min-w-[140px]">Team</th><th class="px-3 py-2 text-right whitespace-nowrap min-w-[50px]" data-sortable data-sort-key="gp">GP</th><th class="px-3 py-2 text-right hidden md:table-cell whitespace-nowrap min-w-[60px]" data-sortable data-sort-key="min">%s</th><th class="px-3 py-2 text-right whitespace-nowrap min-w-[60px]" data-sortable data-sort-key="pts">PTS</th><th class="px-3 py-2 text-right whitespace-nowrap min-w-[60px]" data-sortable data-sort-key="mg" title="MG: 팀 득실마진(PTS - PA)">MG</th><th class="px-3 py-2 text-right hidden md:table-cell whitespace-nowrap min-w-[60px]" data-sortable data-sort-key="pa">PA</th><th class="px-3 py-2 text-right hidden sm:table-cell whitespace-nowrap min-w-[60px]" data-sortable data-sort-key="reb">REB</th><th class="px-3 py-2 text-right hidden sm:table-cell whitespace-nowrap min-w-[60px]" data-sortable data-sort-key="ast">AST</th><th class="px-3 py-2 text-right hidden md:table-cell whitespace-nowrap min-w-[60px]" data-sortable data-sort-key="stl">STL</th><th class="px-3 py-2 text-right hidden md:table-cell whitespace-nowrap min-w-[60px]" data-sortable data-sort-key="blk">BLK</th><th class="px-3 py-2 text-right hidden md:table-cell whitespace-nowrap min-w-[60px]" data-sortable data-sort-key="to">TO</th><th class="px-3 py-2 text-right hidden lg:table-cell whitespace-nowrap min-w-[60px]" data-sortable data-sort-key="fg">FG%%</th><th class="px-3 py-2 text-right hidden lg:table-cell whitespace-nowrap min-w-[60px]" data-sortable data-sort-key="3p">3P%%</th><th class="px-3 py-2 text-right hidden lg:table-cell whitespace-nowrap min-w-[60px]" data-sortable data-sort-key="ft">FT%%</th><th class="px-3 py-2 text-right hidden lg:table-cell whitespace-nowrap min-w-[60px]" data-sortable data-sort-key="efg">eFG%%</th><th class="px-3 py-2 text-right hidden lg:table-cell text-emerald-600 dark:text-emerald-400 whitespace-nowrap min-w-[60px]" data-sortable data-sort-key="ts" title="True Shooting %%">TS%%</th><th class="px-3 py-2 text-right text-orange-600 dark:text-orange-400 whitespace-nowrap min-w-[60px]" data-sortable data-sort-key="eff">EFF</th></tr></thead><tbody>%s</tbody></table></div>|html}
    min_label rows
