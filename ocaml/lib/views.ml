...
let standings_table ~season (standings : team_standing list) =
  ...
  in
  Printf.sprintf
    {html|<div class="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 overflow-x-auto overflow-y-hidden shadow-2xl"><table class="min-w-[560px] sm:min-w-[760px] w-full text-xs sm:text-sm font-mono tabular-nums table-fixed" data-sortable id="standings-table-inner"><thead class="bg-slate-100 dark:bg-slate-800/80 sticky top-0 z-10 text-slate-600 dark:text-slate-400 text-[10px] sm:text-xs uppercase tracking-wider whitespace-nowrap"><tr><th class="px-4 py-3 text-left w-[8%%]">Rk</th><th class="px-4 py-3 text-left font-sans w-[28%%]">Team</th><th class="px-4 py-3 text-right w-[8%%]" data-sortable data-sort-key="gp">GP</th><th class="px-4 py-3 text-right w-[8%%]" data-sortable data-sort-key="w">W</th><th class="px-4 py-3 text-right w-[8%%]" data-sortable data-sort-key="l">L</th><th class="px-4 py-3 text-right w-[10%%]" data-sortable data-sort-key="pct">PCT</th><th class="px-4 py-3 text-right hidden sm:table-cell w-[8%%]" data-sortable data-sort-key="gb">GB</th><th class="px-4 py-3 text-right hidden md:table-cell w-[8%%]" data-sortable data-sort-key="ps">PS/G</th><th class="px-4 py-3 text-right hidden md:table-cell w-[8%%]" data-sortable data-sort-key="pa">PA/G</th><th class="px-4 py-3 text-right hidden sm:table-cell w-[8%%]" data-sortable data-sort-key="diff">DIFF</th></tr></thead><tbody id="standings-body">%s</tbody></table></div>|html}
    rows
...
let games_table (games : game_summary list) =
  ...
  in
  Printf.sprintf
    {html|<div class="space-y-3 sm:hidden">%s</div><div class="hidden sm:block bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 overflow-x-auto overflow-y-hidden shadow-2xl"><table class="min-w-[720px] sm:min-w-[860px] w-full text-xs sm:text-sm font-mono tabular-nums table-fixed"><thead class="bg-slate-100 dark:bg-slate-800/80 sticky top-0 z-10 text-slate-600 dark:text-slate-400 text-[10px] sm:text-xs uppercase tracking-wider whitespace-nowrap"><tr><th class="px-4 py-3 text-left w-[6%%] hidden sm:table-cell">#</th><th class="px-4 py-3 text-left font-sans w-[14%%]">Date</th><th class="px-4 py-3 text-left font-sans w-[28%%]">Home</th><th class="px-4 py-3 text-center w-[14%%]">Score</th><th class="px-4 py-3 text-right font-sans w-[28%%]">Away</th><th class="px-4 py-3 text-right font-sans w-[10%%]">Action</th></tr></thead><tbody id="games-body">%s</tbody></table></div>|html}
    mobile_cards rows
...
let boxscores_table (games : game_summary list) =
  ...
  in
  Printf.sprintf
    {html|<div class="space-y-3 sm:hidden">%s</div><div class="hidden sm:block bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 overflow-x-auto overflow-y-hidden shadow-2xl"><table class="min-w-[720px] sm:min-w-[900px] w-full text-xs sm:text-sm font-mono tabular-nums table-fixed"><thead class="bg-slate-100 dark:bg-slate-800/80 sticky top-0 z-10 text-slate-600 dark:text-slate-400 text-[10px] sm:text-xs uppercase tracking-wider whitespace-nowrap"><tr><th class="px-4 py-3 text-left w-[6%%] hidden sm:table-cell">#</th><th class="px-4 py-3 text-left w-[12%%] font-sans">Date</th><th class="px-4 py-3 text-left font-sans w-[24%%]">Home</th><th class="px-4 py-3 text-center font-sans w-[8%%]">PTS</th><th class="px-4 py-3 text-center font-sans w-[8%%]">PTS</th><th class="px-4 py-3 text-right font-sans w-[24%%]">Away</th><th class="px-4 py-3 text-right font-sans hidden sm:table-cell w-[10%%]">Margin</th><th class="px-4 py-3 text-right w-[8%%] font-sans">Link</th></tr></thead><tbody id="boxscores-body">%s</tbody></table></div>|html}
    mobile_cards rows
