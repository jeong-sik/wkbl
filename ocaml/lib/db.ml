	  ...
	  let get_player_profile ~player_id (module Db : Caqti_lwt.CONNECTION) = 
	    ...
	    | Error e -> Lwt.return (Error e) 
		    ...
		    | Ok (Some p) -> 
		        ...
		        let dummy_avg = { player_id = p.id; name = p.name; team_name = ""; games_played = 0; total_minutes = 0.0; total_points = 0; avg_points = 0.0; avg_margin = 0.0; avg_rebounds = 0.0; avg_assists = 0.0; avg_steals = 0.0; avg_blocks = 0.0; avg_turnovers = 0.0; efficiency = 0.0; } in 
