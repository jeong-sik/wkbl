...
let mvp_candidate_row (candidate: mvp_candidate) =
  ...
  Printf.sprintf
    {html|<tr class="border-b border-slate-200 dark:border-slate-800/60 hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
      <td class="px-3 py-3 text-center">%s</td>
      <td class="px-3 py-3">
      ...
      <td class="px-3 py-3 text-center text-slate-600 dark:text-slate-400">%d</td>
      <td class="px-3 py-3 text-right font-mono text-slate-700 dark:text-slate-300">%s</td>
      <td class="px-3 py-3 text-right font-mono text-slate-700 dark:text-slate-300 hidden md:table-cell">%s</td>
      <td class="px-3 py-3 text-right font-mono text-slate-700 dark:text-slate-300 hidden md:table-cell">%s</td>
      <td class="px-3 py-3 text-right font-mono text-slate-700 dark:text-slate-300 hidden lg:table-cell">%s</td>
      <td class="px-3 py-3 text-right font-mono text-slate-700 dark:text-slate-300 hidden lg:table-cell">%s</td>
      <td class="px-3 py-3 text-right font-mono text-orange-600 dark:text-orange-400 font-bold hidden sm:table-cell">%s</td>
      <td class="px-3 py-3 text-center text-xs text-slate-500 dark:text-slate-400 hidden sm:table-cell">%s</td>
      <td class="px-3 py-3 text-right font-mono font-bold text-sky-600 dark:text-sky-400" title="%s">%s</td>
    </tr>|html}
